...
async def convert_text_to_font(text : str, font : str, text_color : str = "black", max_line : int = 50):
    """Converts text to any font you want, They are 1969 fonts to choose from"""
    image = await convert(text, font, max_line, text_color)
    if image is None:
        return "Error, Font not found. Go to /api/fontconvert/list to get a list of them"
